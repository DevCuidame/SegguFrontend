            ...
            <article className="info-container">
                ...
                <section className="medio">
                    <div className="about-seguro">
                        ...
                        <div className="btn-container">
                            ...
                            <div className="cotizacion">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 18 18">
                    ...
                    <div className="info-seguro">
                        <ul>
                            <li>{insurances.Company?.name}</li>
                            {insurances.category && insurances.category.map((cat, index) => (
                                <li key={index}>{cat}</li>
                            ))}
                            <li>{insurances.type}</li>
                            <li>{insurances.policy_number}</li>
                            <li>Fecha renovación:</li>
                            <li>{insurances.renewal_date}</li>
                            <li>
                                <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock" viewBox="0 0 18 18">
